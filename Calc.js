    ...
    calculating() {
        ...
        input.forEach(item => {
            ...
            if (inputCount) {
                ...
                price.innerHTML = (inputCount * 4.9).toFixed(2);
            } else {
                document.querySelector('.order-finishing-total__amount span').innerHTML = 0;
                price.innerHTML = 0
            }
            if (inputCount >= 50) {
                price.innerHTML = (inputCount * 4.7).toFixed(2);
            }
            if (inputCount >= 75) {
                price.innerHTML = (inputCount * 4.5).toFixed(2);
            }
            if (inputCount >= 100) {
                price.innerHTML = (inputCount * 4.2).toFixed(2);
            }
        })
    }
